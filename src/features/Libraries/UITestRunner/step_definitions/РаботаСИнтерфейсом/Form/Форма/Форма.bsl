...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаГиперссылкуВФорме(Парам01,Парам02)","ЯНажимаюНаГиперссылкуВФорме","Тогда я нажимаю на гиперссылку ""ИмяГиперссылки"" в форме ""ИмяФормы""", "Нажатие на гиперссылку в определенной форме","UI.Формы.Гиперссылки");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаГиперссылкуСИменемВФорме(Парам01,Парам02)","ЯНажимаюНаГиперссылкуСИменемВФорме","Тогда я нажимаю на гиперссылку с именем ""ИмяГиперссылки"" в форме ""ИмяФормы""", "Нажатие на гиперссылку по имени в определенной форме","UI.Формы.Гиперссылки");
...
&НаКлиенте
Процедура НажимаюНаГиперссылкуВФорме(ИмяРеквизита, ЗаголовокФормы, ИскатьПоИмени = Ложь) Экспорт
	
	ТекущаяФорма = Ванесса.НайтиФормуПоЗаголовку(ЗаголовокФормы);
	
	ПолеГиперссылка = Ванесса.НайтиРеквизитФормыПоЗаголовку(ТекущаяФорма, ИмяРеквизита, ИскатьПоИмени, Истина, Неопределено, Неопределено);
...
&НаКлиенте
//Тогда я нажимаю на гиперссылку с "ИмяГиперссылки" в форме "ИмяФормы"
//@ЯНажимаюНаГиперссылкуСИменемВФорме(Парам01,Парам02)
Процедура ЯНажимаюНаГиперссылкуВФорме(Парам01, Парам02) Экспорт
	
	НажимаюНаГиперссылкуВФорме(Парам01, Парам02);
	
КонецПроцедуры

&НаКлиенте
//Тогда я нажимаю на гиперссылку с именем "ИмяГиперссылки" в форме "ИмяФормы"
//@ЯНажимаюНаГиперссылкуСИменемВФорме(Парам01,Парам02)
Процедура ЯНажимаюНаГиперссылкуСИменемВФорме(Парам01, Парам02) Экспорт
	
	НажимаюНаГиперссылкуВФорме(Парам01, Парам02, Истина);
